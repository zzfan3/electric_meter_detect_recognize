...
def test(data,weights=None,batch_size=32,
         imgsz=640,
         conf_thres=0.001,
    ...
    print(pf % ('all', seen, nt.sum(), mp, mr, map50, map75, map90,map))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='./runs/train/head/weights/best.pt', help='model.pt path(s)')
    parser.add_argument('--data', type=str, default='data/brainwash.yaml', help='*.data path')
